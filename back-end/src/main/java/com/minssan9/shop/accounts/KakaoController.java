...
public class KakaoController {
    ...
    @GetMapping("/oauth")
    public Optional<Account> kakaoLogin(String code, Model model, HttpSession session) throws Exception {
        log.debug("code : {}", code);
        ...
        if (!maybeAccount.isPresent()) {
            maybeAccount = Optional.of(accountService.socialRegister(user));
            return maybeAccount;
        }
